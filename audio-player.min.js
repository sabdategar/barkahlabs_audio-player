...
! function(t, e, n, i) {
    ...
    function a(t, e, i, r, a, s) {
        ...
        l.setAttribute("src", e), a && (a = a.replace("\\", "/"), l.setAttribute("type", a)), this.audio.append(l), this.title = "", this.artist = "", this.album = "", this.genre = "", this.durationString = "0:00", this._thumbnail = "", this._thumbnailBlob = "", this._thumbnailBlobUrl = "", this.getThumbnail = function() {
            ...
            t.$volumeBar.width(n + "%")
        }), this.audio.addEventListener("canplay", function() {}), this.audio.addEventListener("play", function() {
            ...
            for (var e = truePlayerEventManager.getEventWatchers("audioEnded"), n = 0; n < e.length; n++) e[n].callback(t);
            ...
            n = n >= 10 ? n : "0" + n, u.durationString = e + ":" + n, u.$parentElem && u.$parentElem.find('[tmplayer-interaction="populate-duration"]').text(u.durationString), t.getCurrentSong() == u && t.$duration.text(u.durationString)
        })
    }
    ...
    s.prototype = {
        init: function() {
            ...
            }), this.setVolume(1), this.initProgressBarEvents(), this.initVolumeBarEvents(), this.initAjaxLoadObserver(), this.initMediaAPIActions(), this.setCurrentSong(0)) : console.error("There are no songs in the player.")
        },
        getVolume: function() {
            return this._volume
        },
        setVolume: function(t) {
            t < 0 ? t = 0 : t > 1 && (t = 1), this.volumeMuteButton.hide(), this.volumeHalfButton.hide(), this.volumeFullButton.hide(), 0 == (0 == t ? this.volumeMuteButton.show() : t < .66 ? this.volumeHalfButton.show() : this.volumeFullButton.show()).length && this.volumeFullButton.show(), this._volume = t, this.getCurrentSong().audio.volume = t
        },
        playCurrentSong: function() {
            e.truePlayerManager.activePlayer && e.truePlayerManager.activePlayer != this && e.truePlayerManager.activePlayer.pauseCurrentSong(), this.pauseButton.show(), this.playButton.hide(), this.getCurrentSong().audio.volume = this.getVolume(), e.truePlayerManager.activePlayer = this, this.getCurrentSong().audio.play()
        },
        stopCurrentSong: function() {
            this.pauseCurrentSong(), this.getCurrentSong().audio.currentTime = 0
        },
        pauseCurrentSong: function() {
            this.pauseButton.hide(), this.playButton.show(), e.truePlayerManager.activePlayer == this && (e.truePlayerManager.activePlayer = null, e.truePlayerManager.previouslyActivePlayer = this), this.getCurrentSong().audio.pause()
        },
        ...
        setCurrentSong: function(t) {
            ...
            n && n.$parentElem && n.targetSetId != e.targetSetId && (n.$parentElem.removeClass("is-current"), this.targetSets[n.targetSetId].removeClass("is-current")), this._currentSongIndex = t, e.$parentElem && (e.$parentElem.addClass("is-current"), this.targetSets[e.targetSetId].addClass("is-current"));
            var i = e.getThumbnail();
            i ? this.$thumbnail.attr("src", i) : this.$thumbnail.removeAttr("src"), this.$songName.text(e.title), this.$albumName.text(e.album), this.$artistName.text(e.artist), this.$duration.text(e.durationString), this.$genre.text(e.genre)
        },
        initProgressBarEvents: function() {
            ...
            n.$progressBarWrapper.on("touchstart", function(i) {
                ...
                n.updateSongDisplayTime(r, a), t(e).on("touchmove.trueAudioPlayer", function(t) {
                    var e = n.scrubSong(t);
                ...
                var r = n.scrubSong(i),
                    a = n.getCurrentSong().audio.duration;
                n.updateSongDisplayTime(r, a), t(e).on("mousemove.trueAudioPlayer", function(t) {
                    var e = n.scrubSong(t);
                    n.updateSongDisplayTime(e, a)
        ...
        initVolumeBarEvents: function() {
            ...
            n.$volumeBarWrapper.on("mousedown", function(i) {
                i.preventDefault(), n.scrubVolume(i), t(e).on("mousemove.trueAudioPlayer", function(t) {
                    n.scrubVolume(t)
                }), t(e).one("mouseup", function() {
                    t(e).off("mousemove.trueAudioPlayer")
                })
            }), n.$volumeBarWrapper.on("touchstart", function(i) {
                i.preventDefault(), n.scrubVolume(i), t(e).on("touchmove.trueAudioPlayer", function(t) {
                    n.scrubVolume(t)
                }), t(e).one("touchend", function() {
        ...
        setPlayerState: function(t, e) {
            ...
            switch (t) {
                case "playing":
                    this.$elem.addClass("is-playing"), n.addClass("is-playing"), i && (i.addClass("is-playing"), r.addClass("is-playing")), "mediaSession" in navigator && (navigator.mediaSession.metadata = new MediaMetadata({
                        title: e.title,
                        artist: e.artist,
                        album: e.album
        ...
        initExternalSong: function(e) {
            var n = this,
                i = t(e),
                r = o();
            n.targetSets[r] = i.find('[tmplayer-interaction="monitor-state"]'), i.find('[tmplayer-action="none"]').on("click", function(t) {
                t.stopPropagation()
            });
            ...
            t(s).on("click", function(t) {
                ...
                e.filter(function(t) {
                    return t.song.id == i
                }).length > 0 ? n.togglePauseCurrentSong() : (n.stopCurrentSong(), n.setCurrentSong(e[0].globalIndex), n.playCurrentSong())
        ...
        grabAndSetSongData: function(e, n, i) {
            ...
            h.$parentElem = o, h.title = r.children('[tmplayer-meta="title"]').text(), h.artist = r.children('[tmplayer-meta="artist"]').text(), h.genre = r.children('[tmplayer-meta="genre"]').text(), h.album = r.children('[tmplayer-meta="album"]').text(), r.children('[tmplayer-meta="thumbnail"]').text() ? h.setThumbnail(r.children('[tmplayer-meta="thumbnail"]').text()) : r.children('[tmplayer-meta="thumbnail"]').attr("src") && h.setThumbnail(r.children('[tmplayer-meta="thumbnail"]').attr("src")), this.songs.push(h)
        },
        rewindSong: function() {
            var currentTime = this.getCurrentSong().audio.currentTime;
            this.getCurrentSong().audio.currentTime = Math.max(currentTime - 15, 0)
        },
        forwardSong: function() {
            var currentTime = this.getCurrentSong().audio.currentTime;
            var duration = this.getCurrentSong().audio.duration;
            this.getCurrentSong().audio.currentTime = Math.min(currentTime + 15, duration)
        },
        ...
        reinitSongs: function() {
            this.songs = [], this.initAllEmbeddedSongs(), this.initAllExternalSongs()
        }
    }, t.fn.extend({
        ...
        this.eventWatchers = [], this.addEventWatcher = function(t, e) {
        ...
        this.activePlayer = null, this.allPlayers = {}, this.previouslyActivePlayer = null, this.initializePlayers = function() {
            var n = this;
